...
- `VITE_SUPABASE_URL` = `https://REDACTED_PROJECT_REF.supabase.co`
- `VITE_SUPABASE_PUBLISHABLE_KEY` = `REDACTED_ANON_KEY`
- `VITE_ADMIN_EMAIL` = `REDACTED_EMAIL`
- `VITE_ADMIN_PASSWORD` = `REDACTED_PASSWORD`
...
2. **Deploy**:
   ...
   - Your admin login will work with: `REDACTED_EMAIL` / `REDACTED_PASSWORD`
